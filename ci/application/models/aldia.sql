...
CREATE  TABLE IF NOT EXISTS `aldia`.`aldia_proyectos` (
  ...
  `proy_hom_jov_benf_direc` INT(11) NOT NULL,
  `proy_hom_adult_benf_direc` INT(11) NOT NULL,
  `proy_hom_ter_benf_direc` INT(11) NOT NULL,
  `proy_muj_jov_benf_direc` INT(11) NOT NULL,
  `proy_muj_adult_benf_direc` INT(11) NOT NULL,
  `proy_muj_ter_benf_direc` INT(11) NOT NULL,
  `proy_hom_jov_benf_indirec` INT(11) NOT NULL,
  `proy_hom_adult_benf_indirec` INT(11) NOT NULL,
  `proy_hom_ter_benf_indirec` INT(11) NOT NULL,
  `proy_muj_jov_benf_indirec` INT(11) NOT NULL,
  `proy_muj_adult_benf_indirec` INT(11) NOT NULL,
  `proy_muj_ter_benf_indirec` INT(11) NOT NULL,
  `proy_map_lat` DOUBLE NOT NULL,
  `proy_map_long` DOUBLE NOT NULL,
  `proy_map_zoom` INT(11) NOT NULL,
  PRIMARY KEY (`proy_id`) ,
